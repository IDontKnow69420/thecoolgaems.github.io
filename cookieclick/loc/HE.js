--Hebrew Translation by TheCoolGaems--
AddLanguage('HE','hebrew',{
	...
	"cookie": "עוגייה",
	"sugar lump": "גוש סוכר",
	"heavenly chip": "שבב שמימי",
	"wrinkler": "קמטים",
	"building": "בִּניָן",
	"upgrade": "שדרוג",
	"golden cookie": "עוגיית זהב",
	"grandmapocalypse": "סבתאפוקליפסה",
	"%1 cookie": [
		"עוגייה %1",
		"%1 עוגיות"
	],
	...
	"Click": "נְקִישָׁה",
	"Shift": "מִשׁמֶרֶת",
	"Shift-click": "לחיצה על Shift",
	"Ctrl": "/",
	"Ctrl-click": "לחיצה על ctrl",
	"Esc": "/",
	"Cookies": "עוגיות",
	"%1 day": [
		"%1 יום",
	...
	"less than 1 second": "לפני פחות משנייה",
	"in %1": "ב-1%",
	"%1 ago": "לפני 1%",
	"%1 remaining": "נותרו 1%",
	"%1 worth": "שווה 1%",
	"%1 of CpS": "1% מהמחירים לשנייה",
	"%1% of bank": "1% מהבנק",
	"per second:": "לשניה",
	"just now": "זֶה עַתָה",
	"a long while": "תקופה ארוכה",
	"forever": "לָנֶצַח",
	"Time remaining:": "זמן שנותר",
	"Big clickable cookie": "עוגיה גדולה ניתנת ללחיצה",
	"Golden cookie": "עוגיית זהב",
	"Wrath cookie": "עוגיית זעם",
	"Reindeer": "אַיָל",
	"Options": "אפשרויות",
	"General": "כללי",
	"Settings": "הגדרות",
	"Volume": "כרך",
	"Volume (music)": "ווליום (מוזיקה)",
	"ON": "עַל",
	"OFF": "כבוי",
	"Fancy graphics": "גרפיקה מפוארת",
	"CSS filters": "מסנני CSS",
	"visual improvements; disabling may improve performance": "שיפורים חזותיים; השבתה עשויה לשפר את הביצועים",
	"Particles": "חלקיקים",
	"Numbers": "מספרים",
	"numbers that pop up when clicking the cookie": "מספרים שצצים בעת לחיצה על קובץ Cookie",
	"Milk [setting]": "חלב",
	"Cursors [setting]": "סמנים",
	"visual display of your cursors": "תצוגה ויזואלית של הסמנים שלך",
	"Wobbly cookie": "עוגיה מתנודדת",
	"Alt cookie sound": "צליל אלטרנטיבה של עוגיות",
	"Icon crates": "ארגזי סמלים",
	"display boxes around upgrades and achievements in Stats": "להציג תיבות סביב שדרוגים והישגים בסטטיסטיקה",
	"Alt font": "גופן alt",
	"your cookies are displayed using a monospace font": "העוגיות שלך מוצגות באמצעות גופן מונוספייס",
	"Short numbers": "מספרים קצרים",
	"Fast notes": "הערות מהירות",
	"notifications disappear much faster": "הודעות נעלמות הרבה יותר מהר",
	"Closing warning": "אזהרת סגירה",
	"the game will ask you to confirm when you close the window": "המשחק יבקש ממך לאשר כאשר תסגור את החלון",
	"Defocus": "ביטול מיקוד",
	"the game will be less resource-intensive when out of focus": "המשחק יהיה פחות עתיר משאבים כשהוא לא בפוקוס",
	"Extra buttons": "כפתורים נוספים",
	"add options on buildings like Mute": "הוסף אפשרויות בבניינים כמו השתקה",
	"Lump confirmation": "אישור גוש",
	"the game will ask you to confirm before spending sugar lumps": "המשחק יבקש ממך לאשר לפני הוצאת גושי סוכר",
	"Custom grandmas": "סבתות בהתאמה אישית",
	"some grandmas will be named after Patreon supporters": "כמה סבתות ייקראו על שם תומכי פטריאון",
	"Scary stuff": "דברים מפחידים",
	"Sleep mode timeout": "פסק זמן של מצב שינה",
	"on slower computers, the game will put itself in sleep mode when it's inactive and starts to lag out; offline CpS production kicks in during sleep mode": "במחשבים איטיים יותר, המשחק יכניס את עצמו למצב שינה כאשר הוא לא פעיל ומתחיל לפגר; ייצור CpS לא מקוון מתחיל במהלך מצב שינה",
	"Music in background": "מוזיקה ברקע",
	"music will keep playing even when the game window isn't focused": "המוזיקה תמשיך להתנגן גם כאשר חלון המשחק אינו ממוקד",
	"Cloud saving": "חיסכון בענן",
	"allow use of Steam Cloud for save backups": "לאפשר שימוש בענן Steam לצורך שמירת גיבויים",
	"Purge Cloud": "/",
	"Current Cloud use:": "/",
